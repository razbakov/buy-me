<template>
  <div class="row">
    <div
      ...
      :key="itemIndex">
      <div class="card" :class="{done: item.done}" @click="triggerIngredient(itemIndex)">
...
export default class Home extends Vue {
  public triggerIngredient(itemIndex: number) {
    this.$store.commit('ingredients/trigger', itemIndex);
  }
}
</script>
